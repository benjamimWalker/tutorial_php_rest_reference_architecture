...
use Fern\Model\User;
use Fern\Psr11;
use Fern\Repository\BaseRepository;
use Fern\Util\HexUuidLiteral;
use Fern\Util\JwtContext;
use Fern\Util\OpenApiContext;
...
class Login
{
    ...
    public function postResetRequest(HttpResponse $response, HttpRequest $request)
    {
        ...
        if (!is_null($user)) {
            ...
            $envelope = Psr11::container()->get('MAIL_ENVELOPE', [$json->email, "Fern - Password Reset", "email_code.html", [
